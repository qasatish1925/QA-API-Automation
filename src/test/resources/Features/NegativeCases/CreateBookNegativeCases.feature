@CreateBookNegative
Feature: Possible Negative Scenarios for Create method:
  ...
  Background: login and store the access token
    ...
    # Expected Code: 400 Bad Request : Expected Response: { "error": "Field 'author' is required" }
  Scenario: Missing required fields (e.g., published_year, author).
    ...
    """
    Then I get a 500 http status code
